...
LOCK TABLES `price_chart` WRITE;
/*!40000 ALTER TABLE `price_chart` DISABLE KEYS */;
INSERT INTO `price_chart` VALUES (1,'4\'X6\'',20),(2,'6\'X4\'',30),(3,'8\'X6\'',40),(4,'6\'X8\'',40);
/*!40000 ALTER TABLE `price_chart` ENABLE KEYS */;
UNLOCK TABLES;
